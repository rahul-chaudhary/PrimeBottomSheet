...
import com.example.primebottomsheet.databinding.FragmentItemListDialogListDialogItemBinding
import com.example.primebottomsheet.databinding.FragmentItemListDialogListDialogBinding
...
//            arguments?.getInt(ARG_ITEM_COUNT)?.let { ItemAdapter(it) }
    ...
    companion object {
        ...
        fun newInstance(itemCount: Int): PrimeDialogFragment =
            PrimeDialogFragment().apply {
